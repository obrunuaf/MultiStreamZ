      ...
      {isOpen && (
        <div className="fixed inset-0 z-9999 flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="w-full max-w-md glass-panel rounded-2xl overflow-hidden relative z-10"
          ...
          >
              ...
              <div className="pt-4 border-t border-white/5 space-y-3">
                <div className="flex items-start gap-3 p-3 bg-blue-500/5 rounded-lg border border-blue-500/10">
                  ...
                  <p className="text-[10px] text-blue-400/80 leading-relaxed">
                    ZMultiLive salva suas lives localmente no navegador. Nenhum dado é enviado para servidores externos.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-6 py-4 bg-black/40 text-center">
              <p className="text-[9px] font-bold text-neutral-700 uppercase tracking-widest">
                ZMultiLive v1.0.0 • Made with ❤️ for Streamers
              </p>
            </div>
          </motion.div>
        </div>
